...
namespace Csrs.Api.Controllers
{
    public class UserRequestController : CsrsControllerBase<UserRequestController>
    {
        ...
        {
            if (userRequest == null || userRequest.FileId == null || userRequest.FileNo == null || userRequest.RequestType == null || userRequest.RequestMessage == null)
            {
                return BadRequest();
            }
            Create.Request request = new(userRequest.FileId, userRequest.FileNo, userRequest.RequestType, userRequest.RequestMessage);
