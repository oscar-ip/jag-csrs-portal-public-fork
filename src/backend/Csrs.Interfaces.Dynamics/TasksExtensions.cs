...
namespace Csrs.Interfaces.Dynamics
{
    ...
    public static partial class TasksExtensions
    {
        ...
        /// The cancellation token.
        /// </param>
        public static async Task<MicrosoftDynamicsCRMtask> GetByPartyAsync(this ITasks operations, string activityid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
        {
            using (var _result = await operations.GetByKeyWithHttpMessagesAsync(activityid, select, expand, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
