...
namespace Csrs.Interfaces.Dynamics.Models
{
    ...
    public partial class MicrosoftDynamicsCRMentitlementcontacts
    {
        ...
        /// MicrosoftDynamicsCRMentitlementcontacts class.
        /// </summary>
        public MicrosoftDynamicsCRMentitlementcontacts(int? importsequencenumber = default(int?), int? utcconversiontimezonecode = default(int?), string entitlementcontactid = default(string), System.DateTimeOffset? overriddencreatedon = default(System.DateTimeOffset?), string contactid = default(string), int? timezoneruleversionnumber = default(int?), string entitlementid = default(string), string name = default(string), string versionnumber = default(string), IList<MicrosoftDynamicsCRMasyncoperation> entitlementcontactsAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), IList<MicrosoftDynamicsCRMmailboxtrackingfolder> entitlementcontactsMailboxTrackingFolders = default(IList<MicrosoftDynamicsCRMmailboxtrackingfolder>), IList<MicrosoftDynamicsCRMbulkdeletefailure> entitlementcontactsBulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> entitlementcontactsPrincipalObjectAttributeAccesses = default(IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess>))
        {
