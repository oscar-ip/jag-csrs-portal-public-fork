...
namespace Csrs.Interfaces.Dynamics.Models
{
    ...
    public partial class MicrosoftDynamicsCRMincidentknowledgebaserecord
    {
        ...
        /// MicrosoftDynamicsCRMincidentknowledgebaserecord class.
        /// </summary>
        public MicrosoftDynamicsCRMincidentknowledgebaserecord(int? utcconversiontimezonecode = default(int?), string incidentknowledgebaserecordid = default(string), int? timezoneruleversionnumber = default(int?), string knowledgebaserecordid = default(string), string versionnumber = default(string), string incidentid = default(string), string name = default(string), System.DateTimeOffset? overriddencreatedon = default(System.DateTimeOffset?), int? importsequencenumber = default(int?), IList<MicrosoftDynamicsCRMasyncoperation> incidentknowledgebaserecordAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), IList<MicrosoftDynamicsCRMmailboxtrackingfolder> incidentknowledgebaserecordMailboxTrackingFolders = default(IList<MicrosoftDynamicsCRMmailboxtrackingfolder>), IList<MicrosoftDynamicsCRMbulkdeletefailure> incidentknowledgebaserecordBulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> incidentknowledgebaserecordPrincipalObjectAttributeAccesses = default(IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess>))
        {
