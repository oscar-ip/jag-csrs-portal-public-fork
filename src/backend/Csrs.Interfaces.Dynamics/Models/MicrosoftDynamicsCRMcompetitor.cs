...
namespace Csrs.Interfaces.Dynamics.Models
{
    ...
    public partial class MicrosoftDynamicsCRMcompetitor
    {
        ...
        /// class.
        /// </summary>
        public MicrosoftDynamicsCRMcompetitor(string address2City = default(string), int? reportingyear = default(int?), string address2County = default(string), string weaknesses = default(string), string traversedpath = default(string), string yominame = default(string), int? importsequencenumber = default(int?), string address1Postalcode = default(string), System.DateTimeOffset? overriddencreatedon = default(System.DateTimeOffset?), string address1Postofficebox = default(string), int? address2Utcoffset = default(int?), int? reportingquarter = default(int?), string address1Composite = default(string), string address2Upszone = default(string), string address1Line2 = default(string), long? entityimageTimestamp = default(long?), string referenceinfourl = default(string), string address2Line3 = default(string), string _transactioncurrencyidValue = default(string), string _modifiedonbehalfbyValue = default(string), string address1Telephone3 = default(string), string address2Postalcode = default(string), decimal? address2Longitude = default(decimal?), string tickersymbol = default(string), string competitorid = default(string), string address1Upszone = default(string), string address2Name = default(string), decimal? address2Latitude = default(decimal?), string name = default(string), int? address1Utcoffset = default(int?), string address1City = default(string), string threats = default(string), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string address1Stateorprovince = default(string), string stockexchange = default(string), string address2Postofficebox = default(string), string _modifiedbyValue = default(string), decimal? winpercentage = default(decimal?), string address2Stateorprovince = default(string), decimal? reportedrevenue = default(decimal?), string strengths = default(string), string opportunities = default(string), byte[] entityimage = default(byte[]), string address1Telephone1 = default(string), string processid = default(string), string address1County = default(string), string address1Telephone2 = default(string), decimal? exchangerate = default(decimal?), string address2Telephone1 = default(string), string address2Composite = default(string), int? address2Shippingmethodcode = default(int?), string _organizationidValue = default(string), string address1Name = default(string), decimal? reportedrevenueBase = default(decimal?), string address2Telephone3 = default(string), string keyproduct = default(string), string address1Line3 = default(string), string address2Fax = default(string), string entityimageid = default(string), string entityimageUrl = default(string), string websiteurl = default(string), string address1Fax = default(string), string overview = default(string), string address1Country = default(string), decimal? address1Latitude = default(decimal?), string address1Addressid = default(string), int? utcconversiontimezonecode = default(int?), int? address2Addresstypecode = default(int?), string stageid = default(string), decimal? address1Longitude = default(decimal?), int? address1Shippingmethodcode = default(int?), string address2Telephone2 = default(string), int? timezoneruleversionnumber = default(int?), string address2Addressid = default(string), string address2Country = default(string), string _createdonbehalfbyValue = default(string), string versionnumber = default(string), string address2Line2 = default(string), int? address1Addresstypecode = default(int?), string _createdbyValue = default(string), string address1Line1 = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string address2Line1 = default(string), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMorganization organizationid = default(MicrosoftDynamicsCRMorganization), IList<MicrosoftDynamicsCRMsyncerror> competitorSyncErrors = default(IList<MicrosoftDynamicsCRMsyncerror>), IList<MicrosoftDynamicsCRMduplicaterecord> competitorDuplicateMatchingRecord = default(IList<MicrosoftDynamicsCRMduplicaterecord>), IList<MicrosoftDynamicsCRMduplicaterecord> competitorDuplicateBaseRecord = default(IList<MicrosoftDynamicsCRMduplicaterecord>), IList<MicrosoftDynamicsCRMasyncoperation> competitorAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), IList<MicrosoftDynamicsCRMmailboxtrackingfolder> competitorMailboxTrackingFolders = default(IList<MicrosoftDynamicsCRMmailboxtrackingfolder>), IList<MicrosoftDynamicsCRMprocesssession> competitorProcessSessions = default(IList<MicrosoftDynamicsCRMprocesssession>), IList<MicrosoftDynamicsCRMbulkdeletefailure> competitorBulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> competitorPrincipalobjectattributeaccess = default(IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess>), MicrosoftDynamicsCRMprocessstage stageidProcessstage = default(MicrosoftDynamicsCRMprocessstage), MicrosoftDynamicsCRMtransactioncurrency transactioncurrencyid = default(MicrosoftDynamicsCRMtransactioncurrency), IList<MicrosoftDynamicsCRMconnection> competitorConnections1 = default(IList<MicrosoftDynamicsCRMconnection>), IList<MicrosoftDynamicsCRMconnection> competitorConnections2 = default(IList<MicrosoftDynamicsCRMconnection>), IList<MicrosoftDynamicsCRMannotation> competitorAnnotation = default(IList<MicrosoftDynamicsCRMannotation>), IList<MicrosoftDynamicsCRMlead> leadcompetitorsAssociation = default(IList<MicrosoftDynamicsCRMlead>), IList<MicrosoftDynamicsCRMopportunity> opportunitycompetitorsAssociation = default(IList<MicrosoftDynamicsCRMopportunity>), IList<MicrosoftDynamicsCRMsalesliterature> competitorsalesliteratureAssociation = default(IList<MicrosoftDynamicsCRMsalesliterature>), IList<MicrosoftDynamicsCRMproduct> competitorproductAssociation = default(IList<MicrosoftDynamicsCRMproduct>), IList<MicrosoftDynamicsCRMcompetitoraddress> competitorAddresses = default(IList<MicrosoftDynamicsCRMcompetitoraddress>), IList<MicrosoftDynamicsCRMopportunityclose> competitorOpportunityActivities = default(IList<MicrosoftDynamicsCRMopportunityclose>), IList<MicrosoftDynamicsCRMpostregarding> competitorPostRegardings = default(IList<MicrosoftDynamicsCRMpostregarding>), IList<MicrosoftDynamicsCRMpostfollow> competitorPostFollows = default(IList<MicrosoftDynamicsCRMpostfollow>))
        {
