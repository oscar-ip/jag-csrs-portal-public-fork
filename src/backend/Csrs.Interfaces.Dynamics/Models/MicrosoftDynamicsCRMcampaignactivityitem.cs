...
namespace Csrs.Interfaces.Dynamics.Models
{
    ...
    public partial class MicrosoftDynamicsCRMcampaignactivityitem
    {
        ...
        /// MicrosoftDynamicsCRMcampaignactivityitem class.
        /// </summary>
        public MicrosoftDynamicsCRMcampaignactivityitem(string owninguser = default(string), string versionnumber = default(string), System.DateTimeOffset? overriddencreatedon = default(System.DateTimeOffset?), string name = default(string), string itemobjecttypecode = default(string), string itemid = default(string), int? timezoneruleversionnumber = default(int?), string campaignactivityitemid = default(string), int? utcconversiontimezonecode = default(int?), int? importsequencenumber = default(int?), string _campaignactivityidValue = default(string), string _owneridValue = default(string), string owningbusinessunit = default(string), IList<MicrosoftDynamicsCRMasyncoperation> campaignactivityitemAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), IList<MicrosoftDynamicsCRMmailboxtrackingfolder> campaignactivityitemMailboxTrackingFolders = default(IList<MicrosoftDynamicsCRMmailboxtrackingfolder>), IList<MicrosoftDynamicsCRMbulkdeletefailure> campaignactivityitemBulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> campaignactivityitemPrincipalObjectAttributeAccesses = default(IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess>), MicrosoftDynamicsCRMactivitypointer campaignactivityid = default(MicrosoftDynamicsCRMactivitypointer))
        {
