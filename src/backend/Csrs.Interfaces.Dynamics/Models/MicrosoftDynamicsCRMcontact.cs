...
namespace Csrs.Interfaces.Dynamics.Models
{
    ...
    public partial class MicrosoftDynamicsCRMcontact
    {
        ...
        public MicrosoftDynamicsCRMcontact(string spousesname = default(string), string emailaddress3 = default(string), string address3Telephone3 = default(string), int? address2Shippingmethodcode = default(int?), string mobilephone = default(string), int? utcconversiontimezonecode = default(int?), string _preferredserviceidValue = default(string), int? address3Shippingmethodcode = default(int?), string address3Postalcode = default(string), string versionnumber = default(string), decimal? annualincome = default(decimal?), string fax = default(string), string telephone3 = default(string), string address1Primarycontactname = default(string), string address3City = default(string), System.DateTimeOffset? lastonholdtime = default(System.DateTimeOffset?), string address2Stateorprovince = default(string), string _createdbyValue = default(string), string address2Line1 = default(string), string assistantphone = default(string), System.DateTimeOffset? lastusedincampaign = default(System.DateTimeOffset?), int? address3Freighttermscode = default(int?), string pager = default(string), string employeeid = default(string), decimal? address1Latitude = default(decimal?), string _parentcustomeridValue = default(string), string managername = default(string), System.DateTimeOffset? birthdate = default(System.DateTimeOffset?), string address1Name = default(string), string department = default(string), string address3Country = default(string), string address2Primarycontactname = default(string), decimal? address2Latitude = default(decimal?), int? territorycode = default(int?), int? timezoneruleversionnumber = default(int?), string address2Postalcode = default(string), long? entityimageTimestamp = default(long?), string _originatingleadidValue = default(string), string _owninguserValue = default(string), bool? participatesinworkflow = default(bool?), bool? merged = default(bool?), string _masteridValue = default(string), string _createdonbehalfbyValue = default(string), string address3Postofficebox = default(string), string subscriptionid = default(string), string business2 = default(string), string address3County = default(string), int? address1Freighttermscode = default(int?), int? customertypecode = default(int?), int? address3Addresstypecode = default(int?), decimal? address1Longitude = default(decimal?), int? address1Addresstypecode = default(int?), int? statuscode = default(int?), string yomifullname = default(string), decimal? aging90Base = default(decimal?), string address3Primarycontactname = default(string), int? familystatuscode = default(int?), string home2 = default(string), string address3Addressid = default(string), int? address2Utcoffset = default(int?), decimal? aging60 = default(decimal?), int? statecode = default(int?), int? address2Freighttermscode = default(int?), string address1Composite = default(string), string telephone2 = default(string), string yomimiddlename = default(string), string _modifiedonbehalfbyValue = default(string), string jobtitle = default(string), int? address3Utcoffset = default(int?), int? address2Addresstypecode = default(int?), int? educationcode = default(int?), string address1Telephone3 = default(string), bool? followemail = default(bool?), int? preferredcontactmethodcode = default(int?), int? importsequencenumber = default(int?), int? gendercode = default(int?), string address2Line2 = default(string), decimal? creditlimitBase = default(decimal?), bool? donotfax = default(bool?), string address3Line1 = default(string), string address1County = default(string), string _owningbusinessunitValue = default(string), string _createdbyexternalpartyValue = default(string), string address1Upszone = default(string), string entityimageid = default(string), string processid = default(string), string address1Telephone2 = default(string), string description = default(string), string address1Fax = default(string), bool? marketingonly = default(bool?), string address3Line2 = default(string), bool? donotpostalmail = default(bool?), string externaluseridentifier = default(string), int? ssgDeleteafterxminutes = default(int?), decimal? aging30Base = default(decimal?), string callback = default(string), string emailaddress2 = default(string), string address2Line3 = default(string), string managerphone = default(string), int? preferredappointmentdaycode = default(int?), string websiteurl = default(string), decimal? exchangerate = default(decimal?), string firstname = default(string), string address1Telephone1 = default(string), string address3Composite = default(string), string address3Fax = default(string), string childrensnames = default(string), string _owningteamValue = default(string), int? numberofchildren = default(int?), string address2Postofficebox = default(string), decimal? aging90 = default(decimal?), bool? donotbulkpostalmail = default(bool?), string emailaddress1 = default(string), bool? donotbulkemail = default(bool?), int? customersizecode = default(int?), string address1City = default(string), int? preferredappointmenttimecode = default(int?), decimal? address3Latitude = default(decimal?), decimal? aging60Base = default(decimal?), string _transactioncurrencyidValue = default(string), byte[] entityimage = default(byte[]), string _modifiedbyexternalpartyValue = default(string), int? paymenttermscode = default(int?), string address3Name = default(string), string address2Telephone1 = default(string), int? leadsourcecode = default(int?), string ftpsiteurl = default(string), int? address1Shippingmethodcode = default(int?), string _modifiedbyValue = default(string), string _preferredsystemuseridValue = default(string), string address2Telephone2 = default(string), string _slainvokedidValue = default(string), string address1Addressid = default(string), string address3Telephone1 = default(string), string nickname = default(string), string address1Postofficebox = default(string), string _preferredequipmentidValue = default(string), string address1Line2 = default(string), string assistantname = default(string), string address2Country = default(string), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string _accountidValue = default(string), string address2Name = default(string), string stageid = default(string), bool? creditonhold = default(bool?), decimal? address3Longitude = default(decimal?), int? onholdtime = default(int?), string address2Telephone3 = default(string), bool? donotphone = default(bool?), string address3Upszone = default(string), string contactid = default(string), decimal? aging30 = default(decimal?), string address2Upszone = default(string), decimal? creditlimit = default(decimal?), int? accountrolecode = default(int?), string salutation = default(string), string suffix = default(string), string traversedpath = default(string), int? address1Utcoffset = default(int?), string governmentid = default(string), string fullname = default(string), string address1Stateorprovince = default(string), bool? donotsendmm = default(bool?), decimal? annualincomeBase = default(decimal?), string address1Country = default(string), string address3Stateorprovince = default(string), string lastname = default(string), string address2City = default(string), bool? donotemail = default(bool?), bool? msdynGdproptout = default(bool?), string company = default(string), decimal? address2Longitude = default(decimal?), string address3Telephone2 = default(string), string yomifirstname = default(string), string telephone1 = default(string), string address1Line1 = default(string), string address2Addressid = default(string), bool? isbackofficecustomer = default(bool?), string address2Composite = default(string), string address2County = default(string), int? shippingmethodcode = default(int?), System.DateTimeOffset? anniversary = default(System.DateTimeOffset?), string _owneridValue = default(string), string _parentcontactidValue = default(string), int? haschildrencode = default(int?), string address2Fax = default(string), string yomilastname = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string entityimageUrl = default(string), string address1Line3 = default(string), string _defaultpricelevelidValue = default(string), string _slaidValue = default(string), string middlename = default(string), string address1Postalcode = default(string), string address3Line3 = default(string), System.DateTimeOffset? overriddencreatedon = default(System.DateTimeOffset?), string timespentbymeonemailandmeetings = default(string), IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> contactPrincipalobjectattributeaccess = default(IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess>), IList<MicrosoftDynamicsCRMlead> leadCustomerContacts = default(IList<MicrosoftDynamicsCRMlead>), IList<MicrosoftDynamicsCRMlead> contactleadsAssociation = default(IList<MicrosoftDynamicsCRMlead>), IList<MicrosoftDynamicsCRMlead> leadParentContact = default(IList<MicrosoftDynamicsCRMlead>), MicrosoftDynamicsCRMlead originatingleadid = default(MicrosoftDynamicsCRMlead), MicrosoftDynamicsCRMpricelevel defaultpricelevelid = default(MicrosoftDynamicsCRMpricelevel), IList<MicrosoftDynamicsCRMbookableresource> contactBookableresourceContactId = default(IList<MicrosoftDynamicsCRMbookableresource>), IList<MicrosoftDynamicsCRMbulkoperation> contactBulkOperations = default(IList<MicrosoftDynamicsCRMbulkoperation>), IList<MicrosoftDynamicsCRMcampaignresponse> contactCampaignResponses = default(IList<MicrosoftDynamicsCRMcampaignresponse>), IList<MicrosoftDynamicsCRMbulkoperationlog> createdContactBulkOperationLogs = default(IList<MicrosoftDynamicsCRMbulkoperationlog>), IList<MicrosoftDynamicsCRMbulkoperationlog> sourceContactBulkOperationLogs = default(IList<MicrosoftDynamicsCRMbulkoperationlog>), IList<MicrosoftDynamicsCRMlist> listcontactAssociation = default(IList<MicrosoftDynamicsCRMlist>), IList<MicrosoftDynamicsCRMserviceappointment> contactServiceAppointments = default(IList<MicrosoftDynamicsCRMserviceappointment>), IList<MicrosoftDynamicsCRMincident> contactAsResponsibleContact = default(IList<MicrosoftDynamicsCRMincident>), IList<MicrosoftDynamicsCRMcontractdetail> contractlineitemCustomerContacts = default(IList<MicrosoftDynamicsCRMcontractdetail>), IList<MicrosoftDynamicsCRMcontract> contractBillingcustomerContacts = default(IList<MicrosoftDynamicsCRMcontract>), IList<MicrosoftDynamicsCRMcontract> contractCustomerContacts = default(IList<MicrosoftDynamicsCRMcontract>), IList<MicrosoftDynamicsCRMincident> incidentCustomerContacts = default(IList<MicrosoftDynamicsCRMincident>), IList<MicrosoftDynamicsCRMincident> contactAsPrimaryContact = default(IList<MicrosoftDynamicsCRMincident>), IList<MicrosoftDynamicsCRMentitlement> contactEntitlementContactId = default(IList<MicrosoftDynamicsCRMentitlement>), IList<MicrosoftDynamicsCRMentitlement> contactEntitlementCustomer = default(IList<MicrosoftDynamicsCRMentitlement>), IList<MicrosoftDynamicsCRMentitlement> entitlementcontactsAssociation = default(IList<MicrosoftDynamicsCRMentitlement>), IList<MicrosoftDynamicsCRMcontract> servicecontractcontactsAssociation = default(IList<MicrosoftDynamicsCRMcontract>), MicrosoftDynamicsCRMequipment preferredequipmentid = default(MicrosoftDynamicsCRMequipment), MicrosoftDynamicsCRMservice preferredserviceid = default(MicrosoftDynamicsCRMservice), IList<MicrosoftDynamicsCRMinvoice> contactinvoicesAssociation = default(IList<MicrosoftDynamicsCRMinvoice>), IList<MicrosoftDynamicsCRMsalesorder> contactordersAssociation = default(IList<MicrosoftDynamicsCRMsalesorder>), IList<MicrosoftDynamicsCRMinvoice> invoiceCustomerContacts = default(IList<MicrosoftDynamicsCRMinvoice>), IList<MicrosoftDynamicsCRMopportunity> opportunityCustomerContacts = default(IList<MicrosoftDynamicsCRMopportunity>), IList<MicrosoftDynamicsCRMsalesorder> orderCustomerContacts = default(IList<MicrosoftDynamicsCRMsalesorder>), IList<MicrosoftDynamicsCRMquote> quoteCustomerContacts = default(IList<MicrosoftDynamicsCRMquote>), IList<MicrosoftDynamicsCRMquote> contactquotesAssociation = default(IList<MicrosoftDynamicsCRMquote>), IList<MicrosoftDynamicsCRMopportunity> opportunityParentContact = default(IList<MicrosoftDynamicsCRMopportunity>), IList<MicrosoftDynamicsCRMafkWorkflowtask> contactAfkWorkflowtasks = default(IList<MicrosoftDynamicsCRMafkWorkflowtask>), IList<MicrosoftDynamicsCRMssgRfimessage> ssgContactSsgRfimessageContactCreatedToSendEmail = default(IList<MicrosoftDynamicsCRMssgRfimessage>), IList<MicrosoftDynamicsCRMconnection> contactConnections1 = default(IList<MicrosoftDynamicsCRMconnection>), IList<MicrosoftDynamicsCRMfeedback> contactFeedback = default(IList<MicrosoftDynamicsCRMfeedback>), IList<MicrosoftDynamicsCRMprocesssession> contactProcessSessions = default(IList<MicrosoftDynamicsCRMprocesssession>), MicrosoftDynamicsCRMprocessstage stageidProcessstage = default(MicrosoftDynamicsCRMprocessstage), IList<MicrosoftDynamicsCRMactivitypointer> contactActivityPointers = default(IList<MicrosoftDynamicsCRMactivitypointer>), IList<MicrosoftDynamicsCRMsocialactivity> contactSocialActivities = default(IList<MicrosoftDynamicsCRMsocialactivity>), IList<MicrosoftDynamicsCRMfeedback> lkContactFeedbackCreatedonbehalfby = default(IList<MicrosoftDynamicsCRMfeedback>), IList<MicrosoftDynamicsCRMpostfollow> contactPostFollows = default(IList<MicrosoftDynamicsCRMpostfollow>), IList<MicrosoftDynamicsCRMpostregarding> contactPostRegardings = default(IList<MicrosoftDynamicsCRMpostregarding>), IList<MicrosoftDynamicsCRMsocialactivity> socialactivityPostauthorContacts = default(IList<MicrosoftDynamicsCRMsocialactivity>), IList<MicrosoftDynamicsCRMphonecall> contactPhonecalls = default(IList<MicrosoftDynamicsCRMphonecall>), IList<MicrosoftDynamicsCRMtask> contactTasks = default(IList<MicrosoftDynamicsCRMtask>), IList<MicrosoftDynamicsCRMsyncerror> contactSyncErrors = default(IList<MicrosoftDynamicsCRMsyncerror>), MicrosoftDynamicsCRMsla slainvokedidContactSla = default(MicrosoftDynamicsCRMsla), MicrosoftDynamicsCRMsla slaContactSla = default(MicrosoftDynamicsCRMsla), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMannotation> contactAnnotation = default(IList<MicrosoftDynamicsCRMannotation>), MicrosoftDynamicsCRMcontact masterid = default(MicrosoftDynamicsCRMcontact), IList<MicrosoftDynamicsCRMcontact> contactMasterContact = default(IList<MicrosoftDynamicsCRMcontact>), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMemail> contactEmailEmailSender = default(IList<MicrosoftDynamicsCRMemail>), IList<MicrosoftDynamicsCRMaccount> accountPrimaryContact = default(IList<MicrosoftDynamicsCRMaccount>), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMactioncard> contactActioncard = default(IList<MicrosoftDynamicsCRMactioncard>), IList<MicrosoftDynamicsCRMsocialactivity> socialactivityPostauthoraccountContacts = default(IList<MicrosoftDynamicsCRMsocialactivity>), IList<MicrosoftDynamicsCRMsocialprofile> socialprofileCustomerContacts = default(IList<MicrosoftDynamicsCRMsocialprofile>), IList<MicrosoftDynamicsCRMcustomeraddress> contactCustomerAddress = default(IList<MicrosoftDynamicsCRMcustomeraddress>), MicrosoftDynamicsCRMbusinessunit owningbusinessunit = default(MicrosoftDynamicsCRMbusinessunit), MicrosoftDynamicsCRMteam owningteam = default(MicrosoftDynamicsCRMteam), MicrosoftDynamicsCRMaccount parentcustomeridAccount = default(MicrosoftDynamicsCRMaccount), IList<MicrosoftDynamicsCRMduplicaterecord> contactDuplicateMatchingRecord = default(IList<MicrosoftDynamicsCRMduplicaterecord>), IList<MicrosoftDynamicsCRMfeedback> lkContactFeedbackCreatedby = default(IList<MicrosoftDynamicsCRMfeedback>), IList<MicrosoftDynamicsCRMslakpiinstance> slakpiinstanceContact = default(IList<MicrosoftDynamicsCRMslakpiinstance>), MicrosoftDynamicsCRMsystemuser preferredsystemuserid = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMfax> contactFaxes = default(IList<MicrosoftDynamicsCRMfax>), IList<MicrosoftDynamicsCRMmailboxtrackingfolder> contactMailboxTrackingFolder = default(IList<MicrosoftDynamicsCRMmailboxtrackingfolder>), IList<MicrosoftDynamicsCRMappointment> contactAppointments = default(IList<MicrosoftDynamicsCRMappointment>), MicrosoftDynamicsCRMsystemuser owninguser = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMasyncoperation> contactAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), MicrosoftDynamicsCRMprincipal ownerid = default(MicrosoftDynamicsCRMprincipal), MicrosoftDynamicsCRMtransactioncurrency transactioncurrencyid = default(MicrosoftDynamicsCRMtransactioncurrency), IList<MicrosoftDynamicsCRMrecurringappointmentmaster> contactRecurringAppointmentMasters = default(IList<MicrosoftDynamicsCRMrecurringappointmentmaster>), IList<MicrosoftDynamicsCRMbulkdeletefailure> contactBulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), MicrosoftDynamicsCRMcontact parentcustomeridContact = default(MicrosoftDynamicsCRMcontact), IList<MicrosoftDynamicsCRMcontact> contactCustomerContacts = default(IList<MicrosoftDynamicsCRMcontact>), IList<MicrosoftDynamicsCRMconnection> contactConnections2 = default(IList<MicrosoftDynamicsCRMconnection>), IList<MicrosoftDynamicsCRMduplicaterecord> contactDuplicateBaseRecord = default(IList<MicrosoftDynamicsCRMduplicaterecord>), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMemail> contactEmails = default(IList<MicrosoftDynamicsCRMemail>), IList<MicrosoftDynamicsCRMactivityparty> contactActivityParties = default(IList<MicrosoftDynamicsCRMactivityparty>), IList<MicrosoftDynamicsCRMletter> contactLetters = default(IList<MicrosoftDynamicsCRMletter>))
        {
            ...
            SsgDeleteafterxminutes = ssgDeleteafterxminutes;
            ...
            ContactAfkWorkflowtasks = contactAfkWorkflowtasks;
            SsgContactSsgRfimessageContactCreatedToSendEmail = ssgContactSsgRfimessageContactCreatedToSendEmail;
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "ssg_deleteafterxminutes")]
        public int? SsgDeleteafterxminutes { get; set; }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "contact_afk_workflowtasks")]
        public IList<MicrosoftDynamicsCRMafkWorkflowtask> ContactAfkWorkflowtasks { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "ssg_contact_ssg_rfimessage_ContactCreatedToSendEmail")]
        public IList<MicrosoftDynamicsCRMssgRfimessage> SsgContactSsgRfimessageContactCreatedToSendEmail { get; set; }
