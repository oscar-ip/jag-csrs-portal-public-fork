...
namespace Csrs.Interfaces.Dynamics.Models
{
    ...
    public partial class MicrosoftDynamicsCRMssgCsrsfile
    {
        ...
        public string SsgRegistrationdate { get; set; }
