...
namespace Csrs.Interfaces.Dynamics.Models
{
    ...
    public partial class MicrosoftDynamicsCRMcompetitoraddress
    {
        ...
        /// MicrosoftDynamicsCRMcompetitoraddress class.
        /// </summary>
        public MicrosoftDynamicsCRMcompetitoraddress(string stateorprovince = default(string), int? importsequencenumber = default(int?), string telephone2 = default(string), string _parentidValue = default(string), string fax = default(string), decimal? latitude = default(decimal?), string telephone3 = default(string), string city = default(string), int? shippingmethodcode = default(int?), string line1 = default(string), string versionnumber = default(string), int? utcoffset = default(int?), int? timezoneruleversionnumber = default(int?), string line2 = default(string), string country = default(string), System.DateTimeOffset? modifiedon = default(System.DateTimeOffset?), string postalcode = default(string), string _modifiedbyValue = default(string), string postofficebox = default(string), string upszone = default(string), int? addressnumber = default(int?), System.DateTimeOffset? overriddencreatedon = default(System.DateTimeOffset?), string line3 = default(string), string _createdbyValue = default(string), int? utcconversiontimezonecode = default(int?), string _createdonbehalfbyValue = default(string), string county = default(string), string telephone1 = default(string), int? addresstypecode = default(int?), string name = default(string), decimal? longitude = default(decimal?), string composite = default(string), System.DateTimeOffset? createdon = default(System.DateTimeOffset?), string competitoraddressid = default(string), string _modifiedonbehalfbyValue = default(string), MicrosoftDynamicsCRMsystemuser createdby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser createdonbehalfby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedby = default(MicrosoftDynamicsCRMsystemuser), MicrosoftDynamicsCRMsystemuser modifiedonbehalfby = default(MicrosoftDynamicsCRMsystemuser), IList<MicrosoftDynamicsCRMsyncerror> competitorAddressSyncErrors = default(IList<MicrosoftDynamicsCRMsyncerror>), IList<MicrosoftDynamicsCRMasyncoperation> competitoraddressAsyncOperations = default(IList<MicrosoftDynamicsCRMasyncoperation>), IList<MicrosoftDynamicsCRMmailboxtrackingfolder> competitoraddressMailboxTrackingFolders = default(IList<MicrosoftDynamicsCRMmailboxtrackingfolder>), IList<MicrosoftDynamicsCRMbulkdeletefailure> competitoraddressBulkDeleteFailures = default(IList<MicrosoftDynamicsCRMbulkdeletefailure>), IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess> competitoraddressPrincipalObjectAttributeAccesses = default(IList<MicrosoftDynamicsCRMprincipalobjectattributeaccess>), MicrosoftDynamicsCRMcompetitor parentid = default(MicrosoftDynamicsCRMcompetitor))
        {
